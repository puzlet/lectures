...
(function() {
  var Arc, ButtonSet, Canvas, Circle, CodeButton, Complex, ComplexPlane, EulerComputation, Exercise, ExerciseBase, ExerciseComplexUnit, ExerciseRotation, Exercises, FigureComplexAddition, FigureComplexMultiplication, FigureComplexPlane, FigureComplexScaling, FigureComplexUnit, FigureComplexUnitMultiply, FigureEulerFormula, Figures, GridLines, HorizontalSlider, KeyHandler, Line, Polygon, Server, Slider, Text, User, Vector, VectorSliderPair, VectorWithCircle, VectorWithTriangle, VerticalAngleSlider, Z1, abs, angleText, complex, j, linspace, pi, processMathJax, round,
  ...
  Figures = (function() {
    ...
    Figures.prototype.loadAce = function(exercisesData) {
      if (exercisesData) {
  ...
  ExerciseComplexUnit = (function(_super) {
    ...
    ExerciseComplexUnit.prototype.forwardVals = function(A) {
      var i, negi, z, _i, _len, _ref, _results;
      if (A == null) {
        A = 1;
      }
      i = j;
    ...
    ExerciseComplexUnit.prototype.run = function(userValues, correctValues) {
      var correctZ, idx, notOk, ok, z1, z2, zValues, _i, _len, _ref;
      ...
      if (zValues.length === correctValues.length) {
        for (idx = _i = 0, _len = zValues.length; _i < _len; idx = ++_i) {
          z1 = zValues[idx];
          z2 = (_ref = correctZ[idx]) != null ? _ref : null;
