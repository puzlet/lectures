...
{Server, Exercises, ExerciseBase, ButtonSet} = $blab.Exercises
{Canvas, Line, Arc, Circle, Polygon, GridLines, Text} = $blab.d3
...
class Figures
  ...
  constructor: ->
    ...
    Server.loadExercises("complex-numbers") if $(".exercises").length
...
# ZZZ $blab.Exericse alternative: register Exercise[...] with Exercises?
